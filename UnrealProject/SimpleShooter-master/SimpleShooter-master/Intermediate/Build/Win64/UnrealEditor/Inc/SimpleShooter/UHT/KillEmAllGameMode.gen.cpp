...
FClassRegistrationInfo Z_Registration_Info_UClass_AKillEmAllGameMode;
UClass* AKillEmAllGameMode::GetPrivateStaticClass()
{
	using TClass = AKillEmAllGameMode;
	if (!Z_Registration_Info_UClass_AKillEmAllGameMode.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("KillEmAllGameMode"),
			Z_Registration_Info_UClass_AKillEmAllGameMode.InnerSingleton,
			StaticRegisterNativesAKillEmAllGameMode,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AKillEmAllGameMode.InnerSingleton;
}
UClass* Z_Construct_UClass_AKillEmAllGameMode_NoRegister()
{
	return AKillEmAllGameMode::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_SimpleShooter_master_Source_SimpleShooter_KillEmAllGameMode_h__Script_SimpleShooter_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AKillEmAllGameMode, AKillEmAllGameMode::StaticClass, TEXT("AKillEmAllGameMode"), &Z_Registration_Info_UClass_AKillEmAllGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AKillEmAllGameMode), 1523767807U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SimpleShooter_master_Source_SimpleShooter_KillEmAllGameMode_h__Script_SimpleShooter_2295580999(TEXT("/Script/SimpleShooter"),
	Z_CompiledInDeferFile_FID_SimpleShooter_master_Source_SimpleShooter_KillEmAllGameMode_h__Script_SimpleShooter_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SimpleShooter_master_Source_SimpleShooter_KillEmAllGameMode_h__Script_SimpleShooter_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
