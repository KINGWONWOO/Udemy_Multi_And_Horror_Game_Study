...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACryptRaiderProjectile_OnHit_Statics::NewProp_Hit = { "Hit", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CryptRaiderProjectile_eventOnHit_Parms, Hit), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Hit_MetaData), NewProp_Hit_MetaData) }; // 267591329
...
FClassRegistrationInfo Z_Registration_Info_UClass_ACryptRaiderProjectile;
UClass* ACryptRaiderProjectile::GetPrivateStaticClass()
{
	using TClass = ACryptRaiderProjectile;
	if (!Z_Registration_Info_UClass_ACryptRaiderProjectile.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("CryptRaiderProjectile"),
			Z_Registration_Info_UClass_ACryptRaiderProjectile.InnerSingleton,
			StaticRegisterNativesACryptRaiderProjectile,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_ACryptRaiderProjectile.InnerSingleton;
}
UClass* Z_Construct_UClass_ACryptRaiderProjectile_NoRegister()
{
	return ACryptRaiderProjectile::GetPrivateStaticClass();
}
struct Z_Construct_UClass_ACryptRaiderProjectile_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ACryptRaiderProjectile_OnHit, "OnHit" }, // 3145028846
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_CryptRaider_Source_CryptRaider_CryptRaiderProjectile_h__Script_CryptRaider_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACryptRaiderProjectile, ACryptRaiderProjectile::StaticClass, TEXT("ACryptRaiderProjectile"), &Z_Registration_Info_UClass_ACryptRaiderProjectile, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACryptRaiderProjectile), 3227997647U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CryptRaider_Source_CryptRaider_CryptRaiderProjectile_h__Script_CryptRaider_2112471321(TEXT("/Script/CryptRaider"),
	Z_CompiledInDeferFile_FID_CryptRaider_Source_CryptRaider_CryptRaiderProjectile_h__Script_CryptRaider_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CryptRaider_Source_CryptRaider_CryptRaiderProjectile_h__Script_CryptRaider_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
